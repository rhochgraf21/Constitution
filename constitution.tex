...
A means to indicate every possible option in the vote will be provided to each House member eligible to cast a vote.
Votes will be accepted for a pre-specified length of time.
At the end of the voting period, votes are no longer accepted and votes are collected and tallied as needed.
