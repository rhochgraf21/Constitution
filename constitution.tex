...
Active Membership is open to all students currently enrolled at RIT who have passed the Intro Evals, their most recent Membership Evals, and signed the Membership Agreement.
...
The Evals Director will then bring them up for an Immediate Relative Majority vote with fifty percent uorum at the next House meeting.
...
\begin{itemize}
	...
	\item Live on floor (if they have On-Floor status)
	\item Hold a CSH Executive Board position
...
Any of these requirements may be waived by the Evaluations Director or a Relative Majority vote by the Executive Board, with one-half Quorum.
\begin{itemize}
	\item Attend all House meetings during the process
	\item Attend at least one House directorship meeting for each week of the process (including permanent and Ad Hoc directorship meetings)
	\item Attend at least two technical seminars 
...
If a member disagrees with the outcome of any E-Board vote, (e.g. is not asked to return to the House for the following year) and wishes to appeal the decision, they may do so as stated in \ref{Appeals}.
\\* \\*
...
\begin{enumerate}
	...
	\item To represent Computer Science House publicly
	\item To coordinate collaboration between Computer Science House and companies in the industry
