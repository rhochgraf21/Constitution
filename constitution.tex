...
\begin{enumerate}
	...
	\item A subset of applicants will be offered Intro Membership and have the opportunity to participate in the Intro Process defined in \ref{The Eval Period}.
...
Intro Members receive the privelege to use CSH facilities, attend CSH functions, and have housing priority over all people who are not CSH members.
...
Alumni Members shall receive the privelege to use CSH facilities and attend CSH functions
...
\begin{enumerate}
	...
	\item To meet, as an E-Board, at least weekly during the Standard Operating Session to discuss and report the operations of CSH
	...
	\item To preside over their respective meeting(s)
...
\begin{enumerate}
	\item Candidates must be a current RTP.
