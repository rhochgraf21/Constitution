...
In order for an Active Member to be eligible to vote during the evaluation process they must meet the requirements outlined in \ref{Expectations of Voting Members}.
...
The Evaluations Director will then bring them up for a One-Half Immediate vote with twenty-five percent Quorum at the next evaluations meeting.
...
\begin{enumerate}
	...
	\item At the end of the voting period, the Chairperson will terminate voting by collecting the ballot box.
...
The sum of the number of votes, excluding Abstentions.
\asubsection{Quorum}
...
A quorum is expressed as a fraction or percentage of Eligible Votes (rounded up) unless otherwise specified.
...
In a Fractional vote, an option in the vote passes if the number of votes cast for that option exceeds a specified fraction of the Votes Cast, rounded up.
