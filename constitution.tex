...
A Leave of Absence offers the option for members to take extended time away from their responsibilities to House for any number of personal issues including, but not limited to, physical illness, mental illness, or care giving for a sick family member. In order to request a Leave of Absence, a member must follow the RIT policy for Leave of Absence, located at \url{https://www.rit.edu/policies/d021}. Additionally, the member should notify the Evaluations Director of their Leave, at which point they become exempt from all House requirements until they return.
