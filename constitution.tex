...
Ad Hoc Directorships are not restricted to single or dual directorship rules.
\asubsubsection{Qualifications of Ad Hoc Director(s)}
...
\item When the Ad Hoc Directorship is granted status, a director(s) is appointed. Subsequently the duties, budget, and the membership considerations are defined.
\end{enumerate}
